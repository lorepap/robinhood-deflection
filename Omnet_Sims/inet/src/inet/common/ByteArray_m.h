...
/**
 * Class generated from <tt>inet/common/ByteArray.msg:25</tt> by opp_msgtool.
 * <pre>
 * //
...
class INET_API ByteArray : public ::omnetpp::cObject
{
  ...
  protected:
    bool operator==(const ByteArray&) = delete;
  ...
  public:
    ...
    [[deprecated]] void insertData(char data) {appendData(data);}
    virtual void appendData(char data);
...
template<> inline inet::ByteArray *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::ByteArray*>(ptr.get<cObject>()); }
