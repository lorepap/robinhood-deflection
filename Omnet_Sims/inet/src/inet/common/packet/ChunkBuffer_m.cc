...
omnetpp::cValue ChunkBuffer__RegionDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    ChunkBuffer::Region *pp = omnetpp::fromAnyPtr<ChunkBuffer::Region>(object); (void)pp;
    switch (field) {
        case FIELD_startOffset: throw omnetpp::cRuntimeError("Cannot return field 'inet::ChunkBuffer::Region::startOffset' (type 'b') as cValue, please provide @toValue in the msg file");
        case FIELD_endOffset: throw omnetpp::cRuntimeError("Cannot return field 'inet::ChunkBuffer::Region::endOffset' (type 'b') as cValue, please provide @toValue in the msg file");
...
omnetpp::cValue ReorderBufferDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    ReorderBuffer *pp = omnetpp::fromAnyPtr<ReorderBuffer>(object); (void)pp;
    switch (field) {
        case FIELD_expectedOffset: throw omnetpp::cRuntimeError("Cannot return field 'inet::ReorderBuffer::expectedOffset' (type 'b') as cValue, please provide @toValue in the msg file");
...
omnetpp::cValue ReassemblyBufferDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    ReassemblyBuffer *pp = omnetpp::fromAnyPtr<ReassemblyBuffer>(object); (void)pp;
    switch (field) {
        case FIELD_expectedLength: throw omnetpp::cRuntimeError("Cannot return field 'inet::ReassemblyBuffer::expectedLength' (type 'b') as cValue, please provide @toValue in the msg file");
