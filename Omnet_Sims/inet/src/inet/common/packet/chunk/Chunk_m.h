...
inline any_ptr toAnyPtr(const inet::RegionTagSet::cObjectRegionTag *p) {if (auto obj = as_cObject(p)) return any_ptr(obj); else return any_ptr(p);}
template<> inline inet::RegionTagSet::cObjectRegionTag *fromAnyPtr(any_ptr ptr) { return ptr.get<inet::RegionTagSet::cObjectRegionTag>(); }
