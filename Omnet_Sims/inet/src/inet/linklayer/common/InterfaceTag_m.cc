...
int PacketInsertionControlTagDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    int baseIndex = base ? base->getFieldCount() : 0;
    if (strcmp(fieldName, "insert_packet_without_checking_the_queue") == 0) return baseIndex + 0;
    return base ? base->findField(fieldName) : -1;
}
...
int PacketInsertionControlTagDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    PacketInsertionControlTag *pp = omnetpp::fromAnyPtr<PacketInsertionControlTag>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void PacketInsertionControlTagDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    PacketInsertionControlTag *pp = omnetpp::fromAnyPtr<PacketInsertionControlTag>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'PacketInsertionControlTag'", field);
    }
}

const char *PacketInsertionControlTagDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string PacketInsertionControlTagDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void PacketInsertionControlTagDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    PacketInsertionControlTag *pp = omnetpp::fromAnyPtr<PacketInsertionControlTag>(object); (void)pp;
    switch (field) {
        case FIELD_insert_packet_without_checking_the_queue: pp->setInsert_packet_without_checking_the_queue(string2bool(value)); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'PacketInsertionControlTag'", field);
    }
}

omnetpp::cValue PacketInsertionControlTagDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    PacketInsertionControlTag *pp = omnetpp::fromAnyPtr<PacketInsertionControlTag>(object); (void)pp;
    switch (field) {
        case FIELD_insert_packet_without_checking_the_queue: return pp->getInsert_packet_without_checking_the_queue();
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'PacketInsertionControlTag' as cValue -- field index out of range?", field);
    }
}

void PacketInsertionControlTagDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    PacketInsertionControlTag *pp = omnetpp::fromAnyPtr<PacketInsertionControlTag>(object); (void)pp;
    switch (field) {
        case FIELD_insert_packet_without_checking_the_queue: pp->setInsert_packet_without_checking_the_queue(value.boolValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'PacketInsertionControlTag'", field);
    }
}
...
omnetpp::any_ptr PacketInsertionControlTagDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void PacketInsertionControlTagDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
