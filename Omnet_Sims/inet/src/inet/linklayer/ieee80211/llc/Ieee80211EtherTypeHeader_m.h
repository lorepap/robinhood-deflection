...
/**
 * Class generated from <tt>inet/linklayer/ieee80211/llc/Ieee80211EtherTypeHeader.msg:29</tt> by opp_msgtool.
 * <pre>
...
class INET_API Ieee80211EtherTypeHeader : public ::inet::FieldsChunk
{
  ...
  protected:
    bool operator==(const Ieee80211EtherTypeHeader&) = delete;
...
template<> inline inet::Ieee80211EtherTypeHeader *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::Ieee80211EtherTypeHeader*>(ptr.get<cObject>()); }
