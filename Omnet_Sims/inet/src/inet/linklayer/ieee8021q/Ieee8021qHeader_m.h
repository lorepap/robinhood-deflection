...
/**
 * Class generated from <tt>inet/linklayer/ieee8021q/Ieee8021qHeader.msg:22</tt> by opp_msgtool.
 * <pre>
...
class INET_API Ieee8021qHeader : public ::inet::FieldsChunk
{
  ...
  protected:
    bool operator==(const Ieee8021qHeader&) = delete;
...
template<> inline inet::Ieee8021qHeader *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::Ieee8021qHeader*>(ptr.get<cObject>()); }
