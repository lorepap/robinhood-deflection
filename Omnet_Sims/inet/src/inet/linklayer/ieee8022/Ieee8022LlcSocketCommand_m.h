...
/**
 * Enum generated from <tt>inet/linklayer/ieee8022/Ieee8022LlcSocketCommand.msg:23</tt> by opp_msgtool.
 * <pre>
...
inline void doParsimPacking(omnetpp::cCommBuffer *b, const Ieee8022LlcSocketCommandCode& e) { b->pack(static_cast<int>(e)); }
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, Ieee8022LlcSocketCommandCode& e) { int n; b->unpack(n); e = static_cast<Ieee8022LlcSocketCommandCode>(n); }

/**
 * Enum generated from <tt>inet/linklayer/ieee8022/Ieee8022LlcSocketCommand.msg:31</tt> by opp_msgtool.
 * <pre>
...
inline void doParsimPacking(omnetpp::cCommBuffer *b, const Ieee8022LlcSocketIndicationCode& e) { b->pack(static_cast<int>(e)); }
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, Ieee8022LlcSocketIndicationCode& e) { int n; b->unpack(n); e = static_cast<Ieee8022LlcSocketIndicationCode>(n); }

/**
 * Class generated from <tt>inet/linklayer/ieee8022/Ieee8022LlcSocketCommand.msg:37</tt> by opp_msgtool.
 * <pre>
...
class INET_API Ieee8022LlcSocketCommand : public ::omnetpp::cObject
{
  ...
  protected:
    bool operator==(const Ieee8022LlcSocketCommand&) = delete;
...
/**
 * Class generated from <tt>inet/linklayer/ieee8022/Ieee8022LlcSocketCommand.msg:41</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/linklayer/ieee8022/Ieee8022LlcSocketCommand.msg:46</tt> by opp_msgtool.
 * <pre>
...
class INET_API Ieee8022LlcSocketCloseCommand : public ::inet::Ieee8022LlcSocketCommand
{
  ...
  protected:
    bool operator==(const Ieee8022LlcSocketCloseCommand&) = delete;
...
/**
 * Class generated from <tt>inet/linklayer/ieee8022/Ieee8022LlcSocketCommand.msg:50</tt> by opp_msgtool.
 * <pre>
...
class INET_API Ieee8022LlcSocketDestroyCommand : public ::inet::Ieee8022LlcSocketCommand
{
  ...
  protected:
    bool operator==(const Ieee8022LlcSocketDestroyCommand&) = delete;
...
/**
 * Class generated from <tt>inet/linklayer/ieee8022/Ieee8022LlcSocketCommand.msg:54</tt> by opp_msgtool.
 * <pre>
...
class INET_API Ieee8022LlcSocketClosedIndication : public ::inet::Ieee8022LlcSocketCommand
{
  ...
  protected:
    bool operator==(const Ieee8022LlcSocketClosedIndication&) = delete;
...
template<> inline inet::Ieee8022LlcSocketCommand *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::Ieee8022LlcSocketCommand*>(ptr.get<cObject>()); }
...
template<> inline inet::Ieee8022LlcSocketCloseCommand *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::Ieee8022LlcSocketCloseCommand*>(ptr.get<cObject>()); }
template<> inline inet::Ieee8022LlcSocketDestroyCommand *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::Ieee8022LlcSocketDestroyCommand*>(ptr.get<cObject>()); }
template<> inline inet::Ieee8022LlcSocketClosedIndication *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::Ieee8022LlcSocketClosedIndication*>(ptr.get<cObject>()); }
