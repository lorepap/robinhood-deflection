...
omnetpp::cValue Ipv4RouteDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Ipv4Route *pp = omnetpp::fromAnyPtr<Ipv4Route>(object); (void)pp;
    switch (field) {
        case FIELD_destination: throw omnetpp::cRuntimeError("Cannot return field 'inet::Ipv4Route::destination' (type 'Ipv4Address') as cValue, please provide @toValue in the msg file");
        case FIELD_netmask: throw omnetpp::cRuntimeError("Cannot return field 'inet::Ipv4Route::netmask' (type 'Ipv4Address') as cValue, please provide @toValue in the msg file");
        case FIELD_gateway: throw omnetpp::cRuntimeError("Cannot return field 'inet::Ipv4Route::gateway' (type 'Ipv4Address') as cValue, please provide @toValue in the msg file");
