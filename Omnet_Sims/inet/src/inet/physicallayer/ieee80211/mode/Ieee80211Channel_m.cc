//
// Generated file, do not edit! Created by opp_msgtool 6.0 from inet/physicallayer/ieee80211/mode/Ieee80211Channel.msg.
//
...
omnetpp::cValue IIeee80211BandDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_centerFrequency: throw omnetpp::cRuntimeError("Cannot return field 'inet::physicallayer::IIeee80211Band::centerFrequency' (type 'Hz') as cValue, please provide @toValue in the msg file");
