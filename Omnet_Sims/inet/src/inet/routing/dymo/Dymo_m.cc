...
omnetpp::cValue AddressBlockDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_sequenceNumber: throw omnetpp::cRuntimeError("Cannot return field 'inet::dymo::AddressBlock::sequenceNumber' (type 'DymoSequenceNumber') as cValue, please provide @toValue in the msg file");
