...
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    return base ? 72+base->getFieldCount() : 72;
}
...
int TcpStateVariablesDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "sentBytes") == 0) return baseIndex + 23;
    if (strcmp(fieldName, "nagle_enabled") == 0) return baseIndex + 24;
    if (strcmp(fieldName, "delayed_acks_enabled") == 0) return baseIndex + 25;
    if (strcmp(fieldName, "limited_transmit_enabled") == 0) return baseIndex + 26;
    if (strcmp(fieldName, "increased_IW_enabled") == 0) return baseIndex + 27;
    if (strcmp(fieldName, "use_custom_IW") == 0) return baseIndex + 28;
    if (strcmp(fieldName, "custom_IW_mult") == 0) return baseIndex + 29;
    if (strcmp(fieldName, "full_sized_segment_counter") == 0) return baseIndex + 30;
    if (strcmp(fieldName, "ack_now") == 0) return baseIndex + 31;
    if (strcmp(fieldName, "afterRto") == 0) return baseIndex + 32;
    if (strcmp(fieldName, "ws_support") == 0) return baseIndex + 33;
    if (strcmp(fieldName, "ws_enabled") == 0) return baseIndex + 34;
    if (strcmp(fieldName, "ws_manual_scale") == 0) return baseIndex + 35;
    if (strcmp(fieldName, "snd_ws") == 0) return baseIndex + 36;
    if (strcmp(fieldName, "rcv_ws") == 0) return baseIndex + 37;
    if (strcmp(fieldName, "rcv_wnd_scale") == 0) return baseIndex + 38;
    if (strcmp(fieldName, "snd_wnd_scale") == 0) return baseIndex + 39;
    if (strcmp(fieldName, "ts_support") == 0) return baseIndex + 40;
    if (strcmp(fieldName, "ts_enabled") == 0) return baseIndex + 41;
    if (strcmp(fieldName, "snd_initial_ts") == 0) return baseIndex + 42;
    if (strcmp(fieldName, "rcv_initial_ts") == 0) return baseIndex + 43;
    if (strcmp(fieldName, "ts_recent") == 0) return baseIndex + 44;
    if (strcmp(fieldName, "last_ack_sent") == 0) return baseIndex + 45;
    if (strcmp(fieldName, "time_last_data_sent") == 0) return baseIndex + 46;
    if (strcmp(fieldName, "sack_support") == 0) return baseIndex + 47;
    if (strcmp(fieldName, "sack_enabled") == 0) return baseIndex + 48;
    if (strcmp(fieldName, "snd_sack_perm") == 0) return baseIndex + 49;
    if (strcmp(fieldName, "rcv_sack_perm") == 0) return baseIndex + 50;
    if (strcmp(fieldName, "start_seqno") == 0) return baseIndex + 51;
    if (strcmp(fieldName, "end_seqno") == 0) return baseIndex + 52;
    if (strcmp(fieldName, "snd_sack") == 0) return baseIndex + 53;
    if (strcmp(fieldName, "snd_dsack") == 0) return baseIndex + 54;
    if (strcmp(fieldName, "highRxt") == 0) return baseIndex + 55;
    if (strcmp(fieldName, "pipe") == 0) return baseIndex + 56;
    if (strcmp(fieldName, "recoveryPoint") == 0) return baseIndex + 57;
    if (strcmp(fieldName, "sackedBytes") == 0) return baseIndex + 58;
    if (strcmp(fieldName, "sackedBytes_old") == 0) return baseIndex + 59;
    if (strcmp(fieldName, "lossRecovery") == 0) return baseIndex + 60;
    if (strcmp(fieldName, "sendQueueLimit") == 0) return baseIndex + 61;
    if (strcmp(fieldName, "queueUpdate") == 0) return baseIndex + 62;
    if (strcmp(fieldName, "dupacks") == 0) return baseIndex + 63;
    if (strcmp(fieldName, "snd_sacks") == 0) return baseIndex + 64;
    if (strcmp(fieldName, "rcv_sacks") == 0) return baseIndex + 65;
    if (strcmp(fieldName, "rcv_oooseg") == 0) return baseIndex + 66;
    if (strcmp(fieldName, "rcv_naseg") == 0) return baseIndex + 67;
    if (strcmp(fieldName, "maxRcvBuffer") == 0) return baseIndex + 68;
    if (strcmp(fieldName, "usedRcvBuffer") == 0) return baseIndex + 69;
    if (strcmp(fieldName, "freeRcvBuffer") == 0) return baseIndex + 70;
    if (strcmp(fieldName, "tcpRcvQueueDrops") == 0) return baseIndex + 71;
    return base ? base->findField(fieldName) : -1;
}
...
omnetpp::cValue TcpStateVariablesDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_sentBytes: return (omnetpp::intval_t)(pp->sentBytes);
        ...
        case FIELD_use_custom_IW: return pp->use_custom_IW;
        case FIELD_custom_IW_mult: return (omnetpp::intval_t)(pp->custom_IW_mult);
        ...
        case FIELD_ts_recent: return pp->ts_recent.dbl();
