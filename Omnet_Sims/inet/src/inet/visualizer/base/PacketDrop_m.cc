...
const char *PacketDropDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_networkInterface: { const ::omnetpp::cObject * value = pp->getNetworkInterface(); return omnetpp::opp_typename(typeid(*value)); }
        default: return nullptr;
    }
}
...
const char *PacketDropDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        ...
        case FIELD_networkInterface: return omnetpp::opp_typename(typeid(::omnetpp::cObject));
